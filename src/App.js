import "./App.css";
import skypeImg from "./img/skype.png";
    ...
    <>
      ...
      <div className="container-fluid d-flex justify-content-between flex-column vh-100">
        <div className="row justify-content-between align-items-center">
          <div className="col-sm-12 col-md-4 col-lg-2 text-sm-center">
            <div className="logotype">El Mov</div>
        ...
        <div className="row">
          <div className="col">
            ...
            <p className="present">
              Мы предлагаем ремонт всех видов электротранспорта по самым доступным ценам в Москве и Московской области.
              Также предоставляются услуги по ремонту и изготовлению аккумуляторов для электросамокатов, моноколёс и
              сигвеев.
            </p>
          </div>
        </div>
      ...
      <div className="container-fluid" id="advantages">
        ...
        <p className="question text-center">
          Если у вас есть вопросы обращайтесь к нам в Skype, WatsApp или Viber или звоните по телефону +7(905)589-97-27
        </p>
      ...
      <div className="container-fluid" id="prices">
        ...
        <div className="text-center final-price">
          Окончательная цена зависит от сложности работ. Но никогда не меняется после того, как мы её назвали{" "}
        </div>
        ...
        <div className="text-center advert">
          Для расчета стоимости ремонта обратитесь в наш сервис по адресу г. Москва, Сигнальный проезд дом 16 с19.{" "}
        </div>

        <div className="question text-center">
          Отправьте сообщение с описанием проблемы нам в Skype, WatsApp или Viber и мы обязательно вам ответим или
          звоните по телефону +7(905)589-97-27{" "}
        </div>
      ...
      <footer className="card-footer">
        <div className="row footer justify-content-center">
          ...
          <div className="d-flex">
            <img src={skypeImg} alt="skype" className="img-fluid messangers " />
            <img src={whatsappImg} alt="viber" className="img-fluid messangers " />
            <img src={viberImg} alt="sviber" className="img-fluid messangers " />
          </div>
        </div>
      </footer>
    </>
